...
public class ItemRepositoryTest {
    ...
    public void QueryDslTest() {
        ...
        // where itemNm like '%item2%' or itemSellStatus = SOLD OUT
        System.out.println(itemRepository.findAll(item.itemNm.contains("item2").or(item.itemSellStatus.eq(ItemStatus.SOLD_OUT))));
