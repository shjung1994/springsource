...
public class BoardController {
    ...
    @PreAuthorize("isAuthenticated()") // 로그인만 사람만 글 쓸 수 있어요
    @GetMapping("/create")
    ...
    @PostMapping("/create")
    public String postCreate(@ModelAttribute("dto") @Valid BoardDTO dto, BindingResult result, PageRequestDTO pageRequestDTO, RedirectAttributes rttr) {
    ...
    public void getList(Model model, PageRequestDTO pageRequestDTO) {
        log.info("board list 요청 {}", pageRequestDTO);
